<script lang="ts">
	import { BookCategory, StarRating } from '$components';
...
<div class="dashboard">
  <div class="dashboard-header mb-m">
    ...
    <div class="headline">
      ...
      <p>There's nothing quite like the journey a good book can take you on.  Have you discovered any new favoritees recently?</p>
    </div>
  </div>
