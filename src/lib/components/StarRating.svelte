...
<div class="rating" role={isReadOnly ? "img" : "group"} aria-label={isReadOnly ? `Rated ${value} out of 5 stars`: "Rate this book"} aria-readonly={isReadOnly}>
  <div class="rating-container">
    {#each Array(5) as _, i}
      <button 
        ...
        aria-pressed={!isReadOnly && value > 1}
